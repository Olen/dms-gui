...
import { Accordion, Button, Translate } from '../components/index.jsx';
...
const Settings = () => {
  ...
  const settingTabs = [
    ...
    },
    {
      ...
      icon: 'house-fill',
      content: <ServerInfos />,
      titleExtra: t('common.for', { what: containerName }),
    },
    {
      id: 3,
      title: 'settings.titleUserConfig',
      icon: 'people-fill',
      content: <UserConfig />,
      titleExtra: t('common.for', { what: containerName }),
    },
    {
      id: 4,
      title: 'settings.titleBranding',
      icon: 'palette',
      content: <FormBranding />,
    },
    {
      id: 5,
      title: 'settings.titleDnscontrol',
      icon: 'globe2',
      content: <DnsProviderConfig />,
      titleExtra: t('common.for', { what: containerName }),
    },
    {
      id: 6,
  ...
  return (
    <>
      ...
      <Accordion
        tabs={settingTabs}
        defaultActiveKey={mailservers.length ? 2 : 1}
      ></Accordion>
    </>
  );
};
