...
- **#82** Split god-modules: `settings.mjs` (2766 lines, part 1 in PR #107) and `db.mjs` (2015 lines → split into `sql.mjs` / `crypto.mjs` / `targetDict.mjs`, part 2 in this PR)
